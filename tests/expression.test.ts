...
const lexerCases = {
	...
	DYNAMIC06: ["Compound expression with a literal first.", "1 + decimal-date-time(now())"],
	DYNAMIC07: [
...
const expectedTokens: Record<string, [LexerCaseKey, string[]]> = {
	...
	TEXT07: [
		"TEXT07",
		[
			"NAME", "WHITESPACE", "NAME", "WHITESPACE", "NAME", "OTHER",
			"WHITESPACE", "OTHER", "OTHER", "OTHER", "OTHER", "OTHER",
			"OTHER", "OTHER", "OTHER", "OTHER",
			"OPEN_PAREN", "CLOSE_PAREN", "NAME",
		],
	],
	...
	GEO02: [
		...
		[
			"NUMBER", "WHITESPACE", "NUMBER", "WHITESPACE",
			"NUMBER", "WHITESPACE", "NUMBER", "OTHER",
			"NUMBER", "WHITESPACE", "NUMBER", "WHITESPACE",
			"NUMBER", "WHITESPACE", "NUMBER",
		],
	],
	...
	DYNAMIC02: [
		"DYNAMIC02",
		[
			"FUNC_CALL", "SYSTEM_LITERAL", "COMMA", "WHITESPACE",
			"SYSTEM_LITERAL", "CLOSE_PAREN",
		],
	],
	DYNAMIC03: [
		"DYNAMIC03",
		[
			"FUNC_CALL", "PARENT_REF", "PATH_SEP", "NAME", "COMMA",
			"WHITESPACE", "SELF_REF", "PATH_SEP", "NAME", "CLOSE_PAREN",
		],
	],
	...
	DYNAMIC05: [
		"DYNAMIC05",
		[
			"FUNC_CALL", "PARENT_REF", "PATH_SEP", "NAME", "WHITESPACE",
			"OPS_COMP", "WHITESPACE", "SYSTEM_LITERAL", "COMMA", "WHITESPACE",
			"NUMBER", "COMMA", "WHITESPACE", "NUMBER", "CLOSE_PAREN",
			"WHITESPACE", "OPS_MATH", "WHITESPACE", "NUMBER", "WHITESPACE",
			"OPS_MATH", "WHITESPACE", "FUNC_CALL", "NUMBER", "CLOSE_PAREN",
		],
	],
	DYNAMIC06: [
		"DYNAMIC06",
		[
			"NUMBER", "WHITESPACE", "OPS_MATH", "WHITESPACE",
			"FUNC_CALL", "FUNC_CALL", "CLOSE_PAREN", "CLOSE_PAREN",
		],
	],
	DYNAMIC07: [
		"DYNAMIC07",
		[
			"FUNC_CALL", "FUNC_CALL", "PARENT_REF", "PATH_SEP", "NAME",
			"WHITESPACE", "OPS_COMP", "WHITESPACE", "SYSTEM_LITERAL",
			"COMMA", "WHITESPACE", "SYSTEM_LITERAL", "COMMA", "WHITESPACE",
			"SYSTEM_LITERAL", "CLOSE_PAREN", "COMMA", "WHITESPACE",
			"SYSTEM_LITERAL", "CLOSE_PAREN",
		],
	],
	DYNAMIC08: [
	...
	DYNAMIC12: [
		"DYNAMIC12",
		[
			"NUMBER", "OPS_MATH", "NUMBER", "WHITESPACE",
			"OPS_MATH", "WHITESPACE", "NUMBER",
		],
	],
	DYNAMIC13: [
		"DYNAMIC13",
		[
			"FUNC_CALL", "CLOSE_PAREN", "WHITESPACE", "OPS_MATH",
			"WHITESPACE", "NUMBER", "WHITESPACE", "OPS_MATH",
			"WHITESPACE", "NUMBER",
		],
	],
	DYNAMIC14: [
		"DYNAMIC14",
		[
			"SELF_REF", "PATH_SEP", "NAME", "WHITESPACE",
			"OPS_MATH", "WHITESPACE", "NUMBER",
		],
	],
	DYNAMIC15: [
		"DYNAMIC15",
		[
			"PARENT_REF", "PATH_SEP", "NAME", "WHITESPACE",
			"OPS_MATH", "WHITESPACE", "SELF_REF", "PATH_SEP", "NAME",
		],
	],
	DYNAMIC16: [
		"DYNAMIC16",
		[
			...
			"NUMBER", "WHITESPACE", "OPS_MATH", "WHITESPACE",
			"NUMBER", "WHITESPACE", "OPS_MATH", "WHITESPACE",
			"NUMBER", "OPS_MATH", "NUMBER", "OPS_MATH", "NUMBER",
		],
	],
	DYNAMIC17: [
		"DYNAMIC17",
	...
	DYNAMIC21: [
		"DYNAMIC21",
		[
			"FUNC_CALL", "PYXFORM_REF", "WHITESPACE", "OPS_COMP",
			"WHITESPACE", "SYSTEM_LITERAL", "COMMA", "WHITESPACE",
			"NUMBER", "COMMA", "WHITESPACE", "PYXFORM_REF", "WHITESPACE",
			"OPS_MATH", "WHITESPACE", "NUMBER", "CLOSE_PAREN",
		],
	],
};
